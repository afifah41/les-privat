...
const tingkatpendLink = document.getElementById("tingkatpend");
const menugroupSection = document.getElementById("menugroup");
const ubahpassSection = document.getElementById("ubahpassgroup");
const tingkatpendSection = document.getElementById("tingkatpendgroup");
...
document.addEventListener("DOMContentLoaded", function () {
	const btnEdit = document.getElementById("btnedit-guru");
	const btnSimpan = document.getElementById("btnsimpan-guru");
